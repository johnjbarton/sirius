...
(function () {
        ...
        function main(inName, depArray, callback, relModuleMap) {
            ...
            for (i = 0; i < depArray.length; i++) {
                ...
                if (depArg) {
                    ...
                    if (req.onDebug) console.log("requirejs loading "+(fullName ||inName)+" dependency: "+depArray[i]+' resolves to '+depName);
                ...
                if (req.jsExtRegExp.test(moduleName)) {
                    ...
                    for (i = syms.length; i > 0; i--) {
                        ...
                        if (paths[parentModule]) {
                            if (req.onDebug) console.log("paths["+parentModule+"]="+paths[parentModule]);
                    ...
                    if ( url.charAt(0) !== '/' && ! url.match(/^\w+:/) ) {
                        ...
                        if (req.onDebug) console.log("url rebased "+config.baseURL+" + "+url);
    ...
    req.onScriptLoad = function (evt) {
        ...
        if (evt.type === "load" || (node && readyRegExp.test(node.readyState))) {
            ...
            context = contexts[contextName];
            if (req.onDebug) console.log("onScriptLoad completing "+moduleName+" url "+node.getAttribute('src'));
